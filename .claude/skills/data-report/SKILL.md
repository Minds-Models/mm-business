...
2. Read `templates/data-report/SPEC.md`. Copy `templates/data-report/skeleton.html` as the
   starting file (canonical look: `templates/deck-style/STYLE.md`); use `reference.html`
   for narrative shape only. Client identity = logo in the co-brand row, accent stays.
