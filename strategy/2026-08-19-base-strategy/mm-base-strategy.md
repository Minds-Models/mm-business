...
| **P2** | **Category Read** — syndicated who×what channel currency: quarterly Excel/API read of segment × engagement × purchase for one category in one chain (T1) → across chains (T2) | Brand insights/trade-marketing (tobacco, pet, drugstore FMCG) | **T1 1.8–3M CZK/yr/brand (€75–122k; 30–60 stores); T2 3–8M CZK/yr/brand (150–300 stores, ≥2 chains)** `[FACT — canon ladder, restated D17 1 Sep; anchored: PMI paid ~8M for the petrol tobacco read; ÚZEI pays ACNielsen 3.7M/yr for a public feed]`; founding seats year-1 **floor €40k / ask €40–60k** (50% off list, max 3/category, density escrow) — below €40k is a study, not a seat | Dima + report factory (exists `[FACT 3.1]`); marginal cost per additional brand ≈ 0 — **this is the 20–60× syndication spread engine** `[FACT 3.8]` | Annual syndicated subscription; KPI integration; category managers re-buy currencies, not reports |
...
Run-rate targets at 18 Feb 2027. FX: 24.5 CZK/€. "Seat" = annual syndicated subscription (auto-renew, density escrow — Module 1/C2). Year-1 founding: max 3/category, floor €40k / ask €40–60k. List T1 €75–122k `[DECIDED — D17]`.
